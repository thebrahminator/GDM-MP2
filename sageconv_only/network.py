from torch_geometric.nn import GraphConv, GatedGraphConv, TopKPooling, EdgePooling, SAGEConv
...
class Rec2(torch.nn.Module):
    def __init__(self):
        ...
        self.conv1 = SAGEConv(256, 256)  # 128
        self.pool1 = TopKPooling(256, ratio=0.8)  # 128
        self.conv2 = SAGEConv(256, 256)  # 128
        self.pool2 = TopKPooling(256, ratio=0.8)  # 128
        self.conv3 = SAGEConv(256, 256)  # 128
        self.pool3 = TopKPooling(256, ratio=0.8)  # 128
        self.conv4 = SAGEConv(256, 256)  # 128
