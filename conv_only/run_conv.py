...
from network import RecNet, train
...
if __name__ == '__main__':
    ...
    sampled_session_id = np.random.choice(clicks_dataset.session_id.unique(), 10000, replace=False)
    clicks_dataset = clicks_dataset.loc[clicks_dataset.session_id.isin(sampled_session_id)]

    print('Picked 10000 random samples...')
